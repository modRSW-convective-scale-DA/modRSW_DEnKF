...
hv_mask = list(range(3*Nk_fc,4*Nk_fc))
...
hr_obs_mask = list(range(n_obs_h+n_obs_u,n_obs_h+n_obs_u+n_obs_v))
hv_obs_mask = list(range(n_obs_h+n_obs_u+n_obs_v,n_obs))
...
axes.plot(list(range(0,Nk_fc)), q[0:200,0],'g',label='h',alpha=alph)
axes.plot(list(range(0,Nk_fc)), q[200:400,0],'r',label='u',alpha=alph)
axes.plot(list(range(0,Nk_fc)), q[400:600,0],'b',label='r',alpha=alph)
axes.plot(list(range(0,Nk_fc)), q[0:200,1:],'g',alpha=alph)
axes.plot(list(range(0,Nk_fc)), q[200:400,1:],'r',alpha=alph)
axes.plot(list(range(0,Nk_fc)), q[400:600,1:],'b',alpha=alph)
...
fig = plt.figure()
axes = fig.add_axes([0.1, 0.1, 0.8, 0.8]) # left, bottom, width, height (range 0 to 1)
axes.plot(list(range(0,Nk_fc)), q2[0:200,0],'g',label='h',alpha=alph)
axes.plot(list(range(0,Nk_fc)), q2[200:400,0],'r',label='u',alpha=alph)
axes.plot(list(range(0,Nk_fc)), q2[400:600,0],'b',label='r',alpha=alph)
axes.plot(list(range(0,Nk_fc)), q2[0:200,1:],'g',alpha=alph)
axes.plot(list(range(0,Nk_fc)), q2[200:400,1:],'r',alpha=alph)
axes.plot(list(range(0,Nk_fc)), q2[400:600,1:],'b',alpha=alph)
#axes.plot(range(0,Nk_fc), q2[0:200,1],'g',linewidth=2)
#axes.plot(range(0,Nk_fc), q2[200:400,1],'r',linewidth=2)
#axes.plot(range(0,Nk_fc), q2[400:600,1],'b',linewidth=2)
axes.set_ylim([-1.5,1.5])
