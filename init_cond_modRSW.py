...
def init_cond_rest(x,Nk,Neq,H0,L,A,V):
...
def init_cond_9(x,Nk,Neq,H0,L,A,V): # multiple top-hats
    ...
    ic1 = H0+A*(heaviside(a1-abs(x-L/4))+heaviside(a2-abs(x-3*L/4))+heaviside(a3-abs(x-L/2)))
    ic2 = np.zeros(len(x))
    ic3 = np.ones(len(x))
    ic4 = np.zeros(len(x))
    ...
    U0[0,:] = 0.5*(ic1[0:Nk] + ic1[1:Nk+1]) # h
    U0[1,:] = 0.5*(ic1[0:Nk]*ic2[0:Nk] + ic1[1:Nk+1]*ic2[1:Nk+1]) # hu
    U0[2,:] = 0.5*(ic1[0:Nk]*ic3[0:Nk] + ic1[1:Nk+1]*ic3[1:Nk+1]) # hv
    U0[3,:] = 0.5*(ic1[0:Nk]*ic4[0:Nk] + ic1[1:Nk+1]*ic4[1:Nk+1]) # hr
...
def init_cond_10(x,Nk,Neq,H0,L,A,V): # multiple top-hats
    ...
    U0[1,:] = 0.5*(ic1[0:Nk]*ic2[0:Nk] + ic1[1:Nk+1]*ic2[1:Nk+1]) # hu
    U0[2,:] = 0.5*(ic1[0:Nk]*ic3[0:Nk] + ic1[1:Nk+1]*ic3[1:Nk+1]) # hv
    U0[3,:] = 0.5*(1.0*ic4[0:Nk] + 1.0*ic4[1:Nk+1]) # hr
