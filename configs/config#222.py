...
'''Output directory'''
outdir = '/nobackup/mmlca/DA_modRSW/config#222'
...
lead_times = [0,3,6]
sig_ic = [0.1,0.05, 0.1, 0.0]                 # initial ens perturbations [h,hu,hr]
ob_noise = [0.1,0.02,0.02,0.006]            # ob noise for [h,u,r]
...
loc = [0.5, 1.0, 1.5, 2.0]
add_inf = [ 0.1, 0.12, 0.15, 0.2, 0.3, 0.4, 0.5]
rtpp = [0.5]
rtps = [ 0.2, 0.4, 0.6, 0.8 ]
