...
'''Output directory'''
outdir = '/nobackup/mmlca/kent_enkf/2xres_1h/config#5'
IAU_dir = ''
...
ob_noise = [0.1,0.025,0.002]            # ob noise for [h,u,r]
...
loc = [ 0.5, 1.0, 1.5, 2.0 ]
add_inf = [ 0.1, 0.2, 0.3, 0.4 ]
rtpp = [0.5]
rtps = [ 0.0, 0.1, 0.2, 0.3, 0.4 ]
