...
'''Output directory'''
outdir = '/nobackup/mmlca/kent_enkf/2xres_1h/config#41'
IAU_dir = ''
...
NIAU = 1000				# DO NOT suppress additive inflation with IAU for the first NIAU hours since assimilation 
tn = 0.0                                # initial time
spin_up = 12
...
ob_noise = [0.1,0.05,0.002]            # ob noise for [h,u,r]
model_noise = [0.0, 0.0, 0.0]        # model-error standard deviations
obs_h_d = 20
obs_u_d = 40
obs_r_d = 20
